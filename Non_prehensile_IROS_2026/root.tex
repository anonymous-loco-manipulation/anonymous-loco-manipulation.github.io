...
\title{\LARGE \bf
Learn2Push: Learning Non-Prehensile Manipulation Across Object Families with Legged Mobile Manipulators}
...
% \author{Ebasa Temesgen$^{1}$, Minghao Zou$^{1}$, Xun Tu$^{1}$, Maria Gini$^{1}$ , Karthik Desingh$^{1}$         %<-this % stops a space
